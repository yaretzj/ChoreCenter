...
public class KidSignup extends AppCompatActivity {
    ...
    public void onClickSignUp(View view) {
        ...
        EditText editParentCode = (EditText) findViewById(R.id.kidSignupText2);

        // Set http request for kid account creation
        ...
        try {
            ...
            jsonObj.put("ParentCode", editParentCode.getText().toString());

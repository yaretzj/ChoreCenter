...
/**
 * An Http Delete request handler for asynchronous tasks.
 * The {@code params} argument to {@code doInBackground} has first element
 * as a url and the second element as the request body.
 */
public class ServiceHandlerDelete extends AsyncTask<String, Integer, String> {
    private static final String TAG = "ServiceHandlerD";
